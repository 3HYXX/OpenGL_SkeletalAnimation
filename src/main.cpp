...
int main()
{
    ...
    // --------------------
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "SkeletalAnimation", NULL, NULL);
    if (window == NULL)
    {
    ...
    // Ground
    float surface[]{-1.0f, 0.0f, -1.0f, 1.0f, 0.0f, -1.0f, 1.0f, 0.0f, 1.0f, -1.0f, 0.0f, 1.0f};
    ...
    vector<std::string> faces{"resources/textures/skybox/right.jpg", "resources/textures/skybox/left.jpg",
    ...
    vector<std::string> faces2{
        "resources/textures/Yokohama2/posx.jpg", "resources/textures/Yokohama2/negx.jpg",
        "resources/textures/Yokohama2/posy.jpg", "resources/textures/Yokohama2/negy.jpg",
        "resources/textures/Yokohama2/posz.jpg", "resources/textures/Yokohama2/negz.jpg",
    };
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model =
            glm::translate(model, glm::vec3(0.0f, 0.0, 0.0f)); // translate it down so it's at the center of the scene
        model = glm::scale(
            model, glm::vec3(modelScale, modelScale, modelScale)); // it's a bit too big for our scene, so scale it down
